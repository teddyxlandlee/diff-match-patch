...
public class DiffMatchPatch {
    ...
    public static void main(String[] args){
        ...
        if (args.length < 2) {
            System.out.println("Need 2 arguments. Provided" + args.length + '.');
        }
        //String text1 = "我方在“福市财政资金补助项目管理系统”的项目实施过程，\n为保证该项目的工程进度、质量，符合数办项目的实施管理规范与要求。";
        //String text2 = "我方在“福州市财政资金补助项目管理系统”的项目实施过程，\n为保证该haha项目的工程进度、质量，符合目的实施管理规范与要求。";
        System.out.println(dmp.getHtmlDiffString(args[0],args[1]));
    }
}